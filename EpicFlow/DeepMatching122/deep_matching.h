/*/home/creator/Projects/C++/REN525
...
typedef vector<dm_res_scale> matching_pyramid_t;
...
// main function. Returns a float_image where each row is <dm_corres_t>
float_image* dm_deep_matching(image_t_dm *img0, image_t_dm *img1, const dm_params_t *params,
                              dm_full_corres_t *corres_out);  // NULL if you don't use it

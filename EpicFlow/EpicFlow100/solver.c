...
void sor_coupled_slow_but_readable(ef_image_t *du, ef_image_t *dv, const ef_image_t *a11, const ef_image_t *a12, const ef_image_t *a22, const ef_image_t *b1, const ef_image_t *b2, const ef_image_t *dpsis_horiz, const ef_image_t *dpsis_vert, const int iterations, const float omega){
    int i,j,iter;

...
typedef struct epic_params_s {
    ...
    float saliency_th;   // matches coming from pixels with a ef_saliency below this threshold are removed before interpolation
...
*/
void epic(ef_image_t *flowx, ef_image_t *flowy, const ef_color_image_t *im, const float_image *input_matches, float_image* edges, const epic_params_t* params, const int n_thread);
